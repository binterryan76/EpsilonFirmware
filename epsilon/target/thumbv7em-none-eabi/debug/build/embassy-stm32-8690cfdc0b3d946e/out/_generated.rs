...
pub mod flash_regions {
    ...
    pub const BANK2_REGION1: crate::flash::FlashRegion = crate::flash::FlashRegion {
    ...
    #[cfg(flash)]
    pub struct Bank2Region1<'d, MODE = crate::flash::Async>(
        pub &'static crate::flash::FlashRegion,
        pub(crate) embassy_hal_internal::PeripheralRef<'d, crate::peripherals::FLASH>,
        pub(crate) core::marker::PhantomData<MODE>,
    );
    pub const BANK2_REGION2: crate::flash::FlashRegion = crate::flash::FlashRegion {
        bank: crate::flash::FlashBank::Bank2,
        base: 135331840u32,
        size: 65536u32,
        erase_size: 65536u32,
    ...
    #[cfg(flash)]
    pub struct Bank2Region2<'d, MODE = crate::flash::Async>(
        pub &'static crate::flash::FlashRegion,
        pub(crate) embassy_hal_internal::PeripheralRef<'d, crate::peripherals::FLASH>,
        pub(crate) core::marker::PhantomData<MODE>,
    );
    pub const BANK2_REGION3: crate::flash::FlashRegion = crate::flash::FlashRegion {
        bank: crate::flash::FlashBank::Bank2,
        base: 135397376u32,
        size: 917504u32,
        erase_size: 131072u32,
    ...
    #[cfg(flash)]
    pub struct Bank2Region3<'d, MODE = crate::flash::Async>(
        pub &'static crate::flash::FlashRegion,
        pub(crate) embassy_hal_internal::PeripheralRef<'d, crate::peripherals::FLASH>,
        pub(crate) core::marker::PhantomData<MODE>,
    );
    ...
    pub struct FlashLayout<'d, MODE = crate::flash::Async> {
        ...
        pub bank2_region1: Bank2Region1<'d, MODE>,
        pub bank2_region2: Bank2Region2<'d, MODE>,
        pub bank2_region3: Bank2Region3<'d, MODE>,
    ...
    impl<'d, MODE> FlashLayout<'d, MODE> {
        pub(crate) fn new(p: embassy_hal_internal::PeripheralRef<'d, crate::peripherals::FLASH>) -> Self {
            Self {
                ...
                bank2_region1: Bank2Region1(
                    &BANK2_REGION1,
                    unsafe { p.clone_unchecked() },
                    core::marker::PhantomData,
                ),
                bank2_region2: Bank2Region2(
                    &BANK2_REGION2,
                    unsafe { p.clone_unchecked() },
                    core::marker::PhantomData,
                ),
                bank2_region3: Bank2Region3(
                    &BANK2_REGION3,
                    unsafe { p.clone_unchecked() },
                    core::marker::PhantomData,
                ),
    ...
    pub const FLASH_REGIONS: [&crate::flash::FlashRegion; 6usize] = [
        &BANK1_REGION1,
        &BANK1_REGION2,
        &BANK1_REGION3,
        &BANK2_REGION1,
...
impl crate::rcc::SealedRccPeripheral for peripherals::DCMI {
    fn frequency() -> crate::time::Hertz {
        unsafe {
            unwrap!(
                crate::rcc::get_freqs().hclk2.to_hertz(),
                "peripheral '{}' is configured to use the '{}' clock, which is not running. \
                    Either enable it in 'config.rcc' or change 'config.rcc.mux' to use another clock",
                "DCMI",
                "HCLK2"
...
impl crate::rcc::SealedRccPeripheral for peripherals::FMC {
    fn frequency() -> crate::time::Hertz {
        unsafe {
            unwrap!(
                crate::rcc::get_freqs().hclk3.to_hertz(),
                "peripheral '{}' is configured to use the '{}' clock, which is not running. \
                    Either enable it in 'config.rcc' or change 'config.rcc.mux' to use another clock",
                "FMC",
                "HCLK3"
